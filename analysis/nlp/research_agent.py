    ...
    def _get_fundamentals(self, ticker) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'profit_margins': info['profitMargins'] * 100 if info.get('profitMargins') is not None else 'N/A',
                'revenue_growth': info['revenueGrowth'] * 100 if info.get('revenueGrowth') is not None else 'N/A',
                'earnings_growth': info['earningsGrowth'] * 100 if info.get('earningsGrowth') is not None else 'N/A',
